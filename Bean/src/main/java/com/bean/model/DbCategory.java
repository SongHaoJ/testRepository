...
public class DbCategory implements Serializable {
    ...
    private String hkinsurancetype;
    ...
    public String getHkinsurancetype() {
        return hkinsurancetype;
    }

    public void setHkinsurancetype(String hkinsurancetype) {
        this.hkinsurancetype = hkinsurancetype == null ? null : hkinsurancetype.trim();
    }
    ...
    public void setHkcategory(String hkcategory) {
        this.hkcategory = hkcategory == null ? null : hkcategory.trim();
    }
    ...
    public void setShortsku(String shortsku) {
        this.shortsku = shortsku == null ? null : shortsku.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getSequenceid() == null ? other.getSequenceid() == null : this.getSequenceid().equals(other.getSequenceid()))
            ...
            && (this.getHkinsurancetype() == null ? other.getHkinsurancetype() == null : this.getHkinsurancetype().equals(other.getHkinsurancetype()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getHkinsurancetype() == null) ? 0 : getHkinsurancetype().hashCode());
        result = prime * result + ((getHkcategory() == null) ? 0 : getHkcategory().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", hkinsurancetype=").append(hkinsurancetype);
        sb.append(", hkcategory=").append(hkcategory);
