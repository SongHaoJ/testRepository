...
public class DbExpense implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        DbExpense other = (DbExpense) that;
        return (this.getSequenceid() == null ? other.getSequenceid() == null : this.getSequenceid().equals(other.getSequenceid()))
            ...
            && (this.getExpencedate() == null ? other.getExpencedate() == null : this.getExpencedate().equals(other.getExpencedate()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getExpencedate() == null) ? 0 : getExpencedate().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", expencedate=").append(expencedate);
