...
public class DbShiptaskItem implements Serializable {
    private Long id;
    ...
    private String lockingoper;

    private Short typesource;
    ...
    public String getLockingoper() {
        return lockingoper;
    }

    public void setLockingoper(String lockingoper) {
        this.lockingoper = lockingoper == null ? null : lockingoper.trim();
    }

    public Short getTypesource() {
        return typesource;
    }

    public void setTypesource(Short typesource) {
    ...
    public boolean equals(Object that) {
        ...
        DbShiptaskItem other = (DbShiptaskItem) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getLockingoper() == null ? other.getLockingoper() == null : this.getLockingoper().equals(other.getLockingoper()))
            && (this.getTypesource() == null ? other.getTypesource() == null : this.getTypesource().equals(other.getTypesource()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLockingoper() == null) ? 0 : getLockingoper().hashCode());
        result = prime * result + ((getTypesource() == null) ? 0 : getTypesource().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", lockingoper=").append(lockingoper);
        sb.append(", typesource=").append(typesource);
