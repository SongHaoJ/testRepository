...
public class DbCdiscountexpresstype implements Serializable {
    private String sid;
    ...
    public void setLogisticurl(String logisticurl) {
        this.logisticurl = logisticurl == null ? null : logisticurl.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        DbCdiscountexpresstype other = (DbCdiscountexpresstype) that;
        return (this.getSid() == null ? other.getSid() == null : this.getSid().equals(other.getSid()))
            ...
            && (this.getLogisticurl() == null ? other.getLogisticurl() == null : this.getLogisticurl().equals(other.getLogisticurl()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLogisticurl() == null) ? 0 : getLogisticurl().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", logisticurl=").append(logisticurl);
